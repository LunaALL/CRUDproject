...
<div class="container">
 <div class="col-lg-4"></div>
  ...
  <!-- 점보트론 -->
   ...
   <h3 style="text-align:center;"><spring:message code="change.pwd"/></h3>
   ...
   <div class="form-group">
   <input type="password" class="form-control" placeholder="비밀번호재확인" name="confirmpassword" maxlength="20">
   <form:errors path="confirmpassword"/>
   </div>
   
   <div class="form-group">
   <input type="submit" class="btn btn-primary form-control" value="비밀번호변경확인">
   </div>
